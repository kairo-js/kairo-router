...
var KairoStartupBeforeEvent = class {
  ...
  api;
  events;
  constructor(ev, isActive, apiRegistry, eventRegistry, getAddonName) {
...
var KairoInitializer = class {
  constructor(runtime, context, contextMutator, random, readyState, apiRegistry, eventRegistry, onCompleted, onDisposed) {
    this.runtime = runtime;
    this.context = context;
    this.contextMutator = contextMutator;
    this.random = random;
