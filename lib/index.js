...
var ActivationRequestSchema = Type2.Object({
  ...
  type: Type2.Union([Type2.Literal("activate"), Type2.Literal("deactivate")])
});
...
var stringifyDiscoveryResponse = (response) => {
  stringify2 ??= fastJson2(DiscoveryResponseSchema);
...
var stringifyRegistrationResponse = (response) => {
  stringify3 ??= fastJson3(RegistrationResponseSchema);
