...
import { CustomCommandStatus, world as world3 } from "@minecraft/server";
...
var KairoCommandRegistry = class {
  ...
  setupInvokeListener(receive) {
    return receive((id, message) => {
      ...
      if (!entry) return;
      const player = payload.playerId ? world3.getAllPlayers().find((p) => p.id === payload.playerId) : void 0;
      try {
...
var CommandParamEntrySchema = Type.Object({
  name: Type.String(),
  type: Type.String()
});
...
var EventEmitMessageSchema = Type2.Object(
  {
    emitterAddonId: Type2.String(),
    eventName: Type2.String(),
    payload: Type2.String(),
    timestamp: Type2.Integer({ minimum: 0 })
  },
  { additionalProperties: false }
);
var EventDeliverMessageSchema = Type2.Object(
  {
    emitterAddonId: Type2.String(),
    eventName: Type2.String(),
    payload: Type2.String(),
...
var validateEventDeliverMessage = compile3(EventDeliverMessageSchema);
...
var HookInvokeMessageSchema = Type3.Object(
  {
    hookCorrelationId: Type3.String(),
    phase: Type3.Union([Type3.Literal("before"), Type3.Literal("after"), Type3.Literal("rollback")]),
    targetAddonId: Type3.String(),
    apiName: Type3.String(),
    declarationSequence: Type3.Integer({ minimum: 0 }),
    args: Type3.String(),
    result: Type3.Optional(Type3.String()),
    rollbackData: Type3.Optional(Type3.String()),
    callerAddonId: Type3.String(),
    callType: Type3.Union([Type3.Literal("send"), Type3.Literal("request")]),
    timestamp: Type3.Integer({ minimum: 0 })
  },
  { additionalProperties: false }
);
var HookResponseMessageSchema = Type3.Object(
  {
    hookCorrelationId: Type3.String(),
    outcome: Type3.Union([
      Type3.Literal("continue"),
      Type3.Literal("cancel"),
      Type3.Literal("cancel_with_result"),
      Type3.Literal("failed")
    ]),
    modifiedArgs: Type3.Optional(Type3.String()),
    cancelResult: Type3.Optional(Type3.String()),
    rollbackData: Type3.Optional(Type3.String()),
    modifiedResult: Type3.Optional(Type3.String()),
    returnedArgs: Type3.Optional(Type3.String()),
...
var CrossAddonHookHandler = class {
  ...
  async handleInvoke(rawMessage) {
    let msg;
    try {
      const parsed = safeJsonParse4(rawMessage, () => new Error("parse failed"));
...
var validateHookInvoke = compile4(HookInvokeMessageSchema);
...
var ActivationResponseSchema = Type4.Object(
  {
    timestamp: Type4.Integer({ minimum: 0 }),
    kairoId: Type4.String(),
    status: Type4.Union([Type4.Literal("success"), Type4.Literal("failure")]),
    action: Type4.Union([Type4.Literal("activate"), Type4.Literal("deactivate")]),
...
import { safeJsonParse as safeJsonParse5, toError as toError2 } from "@kairo-js/utils";
...
// src/router/activation/request/validate.ts
var validateActivationRequest = compile5(ActivationRequestSchema);
...
import { CustomCommandStatus as CustomCommandStatus2 } from "@minecraft/server";
  ...
  registerCommand(customCommand, callback) {
    this.registry.registerCommand(customCommand, (origin, ...args) => {
      if (!this.isActive()) {
        ...
        return { status: CustomCommandStatus2.Failure, message: `${name} is inactive.` };
      }
...
import { safeJsonParse as safeJsonParse6, toError as toError3 } from "@kairo-js/utils";
...
// src/router/init/discovery/query/validate.ts
var validateDiscoveryQuery = compile6(DiscoveryQuerySchema);
...
var DiscoveryResponseSchema = Type7.Object(
  {
...
import { safeJsonParse as safeJsonParse7, toError as toError5 } from "@kairo-js/utils";
...
var RegistrationRequestSchema = Type8.Object(
  {
    approvals: Type8.Array(Type8.String()),
    rejects: Type8.Array(Type8.String()),
...
// src/router/init/registration/request/validate.ts
var validateRegistrationRequest = compile7(RegistrationRequestSchema);
...
import { safeJsonParse as safeJsonParse8, toError as toError6 } from "@kairo-js/utils";
...
var RegistrationResultSchema = Type9.Object(
  {
    kairoId: Type9.String(),
    success: Type9.Boolean(),
    reason: Type9.Optional(Type9.String()),
    timestamp: Type9.Integer({ minimum: 0 })
  },
  {
    additionalProperties: false
  }
...
// src/router/init/registration/result/validate.ts
var validateRegistrationResult = compile8(RegistrationResultSchema);
...
var RegistrationResponseSchema = Type10.Object(
  {
    kairoRegistry: Type10.Object({
      kairoId: Type10.Readonly(Type10.String()),
      addonId: Type10.Readonly(Type10.String()),
      name: Type10.Readonly(Type10.String()),
      description: Type10.Readonly(Type10.String()),
      version: Type10.Readonly(
        Type10.Object({
          major: Type10.Number(),
          minor: Type10.Number(),
          patch: Type10.Number(),
          prerelease: Type10.Optional(Type10.String()),
          build: Type10.Optional(Type10.String())
        })
      ),
      metadata: Type10.Readonly(
        Type10.Object({
          authors: Type10.Readonly(Type10.Array(Type10.String())),
          url: Type10.Optional(Type10.String()),
          license: Type10.Optional(Type10.String())
        })
      ),
      dependencies: Type10.Readonly(Type10.Record(Type10.String(), Type10.String())),
      optionalDependencies: Type10.Readonly(Type10.Record(Type10.String(), Type10.String())),
      tags: Type10.Readonly(Type10.Array(Type10.String()))
    }),
    timestamp: Type10.Integer({ minimum: 0 })
  },
  {
    additionalProperties: false
  }
...
// src/router/init/registration/response/stringify.ts
var stringifyRegistrationResponse = fastJson3(RegistrationResponseSchema);
