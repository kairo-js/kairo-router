...
import { SeedRandom as SeedRandom3 } from "@kairo-js/utils";
...
var KairoInitializer = class {
  constructor(runtime, context, contextMutator, random = new SeedRandom2(), readyState, onCompleted, onDisposed) {
