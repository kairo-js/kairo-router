...
var DiscoveryQueryParser = class {
  ...
  assertQuery(query) {
    ...
    const currentTick = system2.currentTick;
...
// src/router/init/discovery/format/discoveryResponse.stringify.ts
import fastJson from "fast-json-stringify";

// src/router/init/discovery/format/discoveryResponse.schema.ts
