import { SCRIPT_EVENT_COMMAND_TYPES, SCRIPT_EVENT_ID_PREFIX } from "../____constants/scriptevent";
import { KAIRO_COMMAND_TARGET_ADDON_IDS } from "../____constants/system";
