import { KairoAddonProperties, SemVer } from "../____constants/properties";
import { Kairo } from "./Kairo";
import { KairoUtils } from "../____utils/KairoUtils";
...
export class AddonPropertyManager {
    ...
    public static create(kairo: Kairo, properties: KairoAddonProperties): AddonPropertyManager {
